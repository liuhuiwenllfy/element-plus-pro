...
<template>
  <el-radio-group v-model="radio" @change="handleChange">
    ...
    <el-radio :value="6">指定</el-radio>
    <el-checkbox-group v-model="checkList" @change="handleChange(6)">
      <el-checkbox v-for="index in 7" :key="index" :value="index">{{ index }}</el-checkbox>
    </el-checkbox-group>
  </el-radio-group>
</template>
